var app = angular.module('ScaffoldsApp', ['ScaffoldsApp.directives', 'ScaffoldsApp.services', 'ScaffoldsApp.controllers', 'ngRoute'])
    ...
    $routeProvider
      ...
      .when('/project1', {
        ...
        resolve: {
          ...
          loadone: function (queryService) {
            return queryService.onload(20130905007);
          }
        }
      })
      .when('/mobile', {
